...
-- substitutes for NO ACTION -> RESTRICS = parent row eka delete krata meke data delete wenaha
--(Delete krna widi)            SET NULL   = delete unot field eka null kranna
--                              SET DEFAULT = delete unot meke default value eka apply wenwa.default ekata value ekak table creation eke place krnna nattan fail ewenawa
--                              NOT ACTION = kisima action ekak krnna epa

-- ON UPDATE CASCADE kiyanne parent update unot meke auto maru wenawada
